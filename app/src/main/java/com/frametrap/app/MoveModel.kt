...
class MoveModel(private val prop_movename: String, private val prop_startup: String, private val prop_active: String, private val prop_recovery: String, private val prop_onBlock: String, private val prop_movetype: String) {
